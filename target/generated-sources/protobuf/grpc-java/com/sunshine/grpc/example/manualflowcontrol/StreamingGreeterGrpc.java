...
public final class StreamingGreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sunshine.grpc.example.manualflowcontrol.HelloRequest,
      com.sunshine.grpc.example.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHelloStreaming",
      requestType = com.sunshine.grpc.example.manualflowcontrol.HelloRequest.class,
      responseType = com.sunshine.grpc.example.manualflowcontrol.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.sunshine.grpc.example.manualflowcontrol.HelloRequest,
      com.sunshine.grpc.example.manualflowcontrol.HelloReply> getSayHelloStreamingMethod() {
    io.grpc.MethodDescriptor<com.sunshine.grpc.example.manualflowcontrol.HelloRequest, com.sunshine.grpc.example.manualflowcontrol.HelloReply> getSayHelloStreamingMethod;
      ...
      synchronized (StreamingGreeterGrpc.class) {
        if ((getSayHelloStreamingMethod = StreamingGreeterGrpc.getSayHelloStreamingMethod) == null) {
          StreamingGreeterGrpc.getSayHelloStreamingMethod = getSayHelloStreamingMethod =
              io.grpc.MethodDescriptor.<com.sunshine.grpc.example.manualflowcontrol.HelloRequest, com.sunshine.grpc.example.manualflowcontrol.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHelloStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sunshine.grpc.example.manualflowcontrol.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sunshine.grpc.example.manualflowcontrol.HelloReply.getDefaultInstance()))
  ...
  public static abstract class StreamingGreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.sunshine.grpc.example.manualflowcontrol.HelloRequest> sayHelloStreaming(
        io.grpc.stub.StreamObserver<com.sunshine.grpc.example.manualflowcontrol.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                com.sunshine.grpc.example.manualflowcontrol.HelloRequest,
                com.sunshine.grpc.example.manualflowcontrol.HelloReply>(
  ...
  private static abstract class StreamingGreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sunshine.grpc.example.manualflowcontrol.HelloStreamingProto.getDescriptor();
    }
